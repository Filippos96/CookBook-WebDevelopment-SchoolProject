<script>
  ...
  import Navbar from "./routes/NavigationBar/Navbar.svelte";
  import Sidebar from "./routes/NavigationBar/Sidebar.svelte";
...
<main>
  ...
  <Router>
    ...
    <Route path="/recipes/:id/comments" component={Comments} />
